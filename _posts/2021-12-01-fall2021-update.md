...
tags: undergraduate-research grants 4VA
categories: research
---
...
With the graduation of [Sophia Cronin](https://www.linkedin.com/in/sophiacronin/) (Microsoft) and [Jonathan Li](https://www.linkedin.com/in/lijonathancj/) (Dev Technology Group) we are in need of new undergraduate researchers. We are excited to welcome to the research group:

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/headshots/caulfield.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Megan Caulfield
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/headshots/dolansky.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Dawson Dolansky
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/headshots/white.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Riley White
        </div>
    </div>
